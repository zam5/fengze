 ...
 <body style="overflow-x:hidden;overflow-y:auto;">
     <div id="table" class="mt10">
        <div class="box span10 oh">
              ...
              <tr width="100"><a href="news_add.php">添加</a></tr><br/></br>
                <tr>
                   <th width="30">全选</th>
                   <th width="30">ID</th>
                   <th width="70">分类</th>
               ...
               <?php
                  ...
                  $res=mysqli_query($conn,$sql);
                    ...
                    $list=($page-1)*$num;
                    $sql1="select * from news limit $list,$num";
               ...
               while($row=mysqli_fetch_array($res1)){
                  ...
                  echo"<a href = 'do_delete.php?news_id=".$row['news_id']."&del_id=2'>删除</a></td>";
                   echo"</tr>";
                }
            ...
            ?>
              ...
              <div class="page mt10">
                <div class="pagination">
                  <ul>
                      <li class="first-child"><a href="news.php">首页</a></li>
                      <li ><a href="news.php?page=<?php echo $ps?>">上一页</a></li>
                      <li ><a href="news.php?page=1">1</a></li>
                      <li><a href="news.php?page=2">2</a></li>
                      <li><a href="news.php?page=<?php echo $px?>">下一页</a></li>
                      <li class="last-child"><a href="news.php?page=<?php echo $page_num_all;?>">末页</a></li>
                  </ul>
                </div>
